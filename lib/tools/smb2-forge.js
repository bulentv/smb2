...
var messageHandlers = {
  'close': require('../messages/close.js'),
  'create': require('../messages/create.js'),
  'create_folder': require('../messages/create_folder.js'),
  'negotiate': require('../messages/negotiate.js'),
  'open': require('../messages/open.js'),
  'open_folder': require('../messages/open_folder.js'),
  'query_directory': require('../messages/query_directory.js'),
  'read': require('../messages/read.js'),
  'session_setup_step1': require('../messages/session_setup_step1.js'),
  'session_setup_step2': require('../messages/session_setup_step2.js'),
  'set_info': require('../messages/set_info.js'),
  'tree_connect': require('../messages/tree_connect.js'),
  'write': require('../messages/write.js'),
}
...
SMB2Forge.request = function(messageName, params, connection, cb) {
  var msg = messageHandlers[messageName];
