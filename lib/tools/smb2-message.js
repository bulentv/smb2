var structures = {
  'close': require('../structures/close.js'),
  'constants': require('../structures/constants.js'),
  'create': require('../structures/create.js'),
  'negotiate': require('../structures/negotiate.js'),
  'query_directory': require('../structures/query_directory.js'),
  'read': require('../structures/read.js'),
  'session_setup': require('../structures/session_setup.js'),
  'set_info': require('../structures/set_info.js'),
  'tree_connect': require('../structures/tree_connect.js'),
  'write': require('../structures/write.js'),
}
...
function readHeaders(message, buffer) {
  ...
  message.structure = structures[message.headers['Command'].toLowerCase()];
}
